...
data_tests = [None, None, None]
running_tests(data_tests)


def test_co2_empty():
    global count_tests
    co2_element.screenshot('./output/34.png')
    assert 1 == 1


def test_water_empty():
    global count_tests
    water_element.screenshot('./output/35.png')
    assert 1 == 1


def test_energy_empty():
    global count_tests
    energy_element.screenshot('./output/36.png')
    assert 1 == 1
