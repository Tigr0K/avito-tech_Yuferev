...
data_tests = [1000000, 1000000, 1000000]
running_tests(data_tests)


def test_co2_1000000():
    global count_tests
    co2_element.screenshot('./output/25.png')
    assert 1 == 1


def test_water_1000000():
    global count_tests
    water_element.screenshot('./output/26.png')
    assert 1 == 1


def test_energy_1000000():
    global count_tests
    energy_element.screenshot('./output/27.png')
    assert 1 == 1
