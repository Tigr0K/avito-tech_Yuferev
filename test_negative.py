...
def test_co2_negative():
    global count_tests
    co2_element.screenshot('./output/7.png')
    assert 1 == 1


def test_water_negative():
    global count_tests
    water_element.screenshot('./output/8.png')
    assert 1 == 1


def test_energy_negative():
    global count_tests
    energy_element.screenshot('./output/9.png')
    assert 1 == 1
