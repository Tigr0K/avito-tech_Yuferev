...
#Тест-кейсы значения 1049
data_tests = [1049, 1049, 1049]
running_tests(data_tests)


def test_co2_1049():
    global count_tests
    co2_element.screenshot('./output/16.png')
    assert 1 == 1


def test_water_1049():
    global count_tests
    water_element.screenshot('./output/17.png')
    assert 1 == 1


def test_energy_1049():
    global count_tests
    energy_element.screenshot('./output/18.png')
    assert 1 == 1
