...
data_tests = [999999, 999999, 999999]
running_tests(data_tests)


def test_co2_999999():
    global count_tests
    co2_element.screenshot('./output/22.png')
    assert 1 == 1


def test_water_999999():
    global count_tests
    water_element.screenshot('./output/23.png')
    assert 1 == 1


def test_energy_999999():
    global count_tests
    energy_element.screenshot('./output/24.png')
    assert 1 == 1
