...
data_tests = [1000, 1000, 1000]
running_tests(data_tests)


def test_co2_1000():
    global count_tests
    co2_element.screenshot('./output/13.png')
    assert 1 == 1


def test_water_1000():
    global count_tests
    water_element.screenshot('./output/14.png')
    assert 1 == 1


def test_energy_1000():
    global count_tests
    energy_element.screenshot('./output/15.png')
    assert 1 == 1
